...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='off_sample_off_rollout-deepseek1.5b-train-v2.0' \
    trainer.prompt_tracking.save_dir='/mnt/bn/robotics-rl-lf/vlm_datasets/DeepScaleR-Preview-Dataset/off_sample_off_rollout-deepseek1.5b-train-v2.0-tracking_results' \
