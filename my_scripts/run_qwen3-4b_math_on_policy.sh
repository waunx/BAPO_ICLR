...
TRAIN_DATA_PATH=/mnt/bn/robotics-rl-lf/vlm_datasets/countdown/countdown_sampled_10k.parquet
VAL_DATA_PATH=/mnt/bn/robotics-rl-lf/vlm_datasets/countdown/test.parquet
REWARD_PATH=/opt/tiger/e2e_alg/vlm/verl/verl/utils/reward_score/countdown.py
...
python3 -m verl.trainer.main_ppo \
    ...
    algorithm.off_policy_reeval_freq=10 \
    ...
    trainer.experiment_name='on_sample_on_rollout-qwen3_1.7b-countdown' \
    trainer.prompt_tracking.save_dir='/mnt/bn/robotics-rl-lf/vlm_datasets/TotalEval/on_sample_on_rollout-qwen3_1.7b-countdown-tracking_results' \
