...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='off_sample_off_rollout-qwen3_1.7b-0722-v2-countdown' \
    trainer.prompt_tracking.save_dir='/mnt/bn/robotics-rl-lf/vlm_datasets/TotalEval/off_sample_off_rollout-qwen3_1.7b-0722-v2-countdown-tracking_results' \
