...
python3 -m verl.trainer.main_ppo \
    ...
    algorithm.enable_completion_batch=False \
    ...
    trainer.experiment_name='on_sample_on_rollout-qwenvl_3b-geo3k-micro_8' \
    trainer.prompt_tracking.save_dir='/mnt/bn/robotics-rl-lf/vlm_datasets/geometry3k/on_sample_on_rollout-qwenvl_3b-geometry3k-micro_8-tracking_results' \
