...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='off_sample_off_rollout-qwen3_4b-deepscaler' \
    trainer.prompt_tracking.save_dir='/mnt/bn/robotics-rl-lf/vlm_datasets/TotalEval/off_sample_off_rollout-qwen3_4b-multieval-tracking_results' \
