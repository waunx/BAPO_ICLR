...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='on_sample_on_rollout-deepseek1.5b-train-v2.0' \
    trainer.prompt_tracking.save_dir='/mnt/bn/robotics-rl-lf/vlm_datasets/DeepScaleR-Preview-Dataset/on_sample_on_rollout-deepseek1.5b-train-v2.0-tracking_results' \
