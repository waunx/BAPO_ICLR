...
VAL_DATA_PATH=/mnt/bn/robotics-rl-lf/vlm_datasets/countdown/countdown_sampled_1k.parquet
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='on_sample_on_rollout-qwen2_1.5b-countdown-train' \
    trainer.prompt_tracking.save_dir='/mnt/bn/robotics-rl-lf/vlm_datasets/countdown/on_sample_on_rollout-qwen2_1.5b-countdown-train-tracking_results' \
