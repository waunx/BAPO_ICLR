...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='on_sample_on_rollout-qwen_3_1.7b-deepscaler' \
    trainer.prompt_tracking.save_dir='/mnt/bn/robotics-rl-lf/vlm_datasets/TotalEval/on_sample_on_rollout-qwen_3_1.7b-tracking_results' \
