...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='off_sample_off_rollout-deepseek7b-freq_5_5-128x2_train' \
    trainer.prompt_tracking.save_dir='/mnt/bn/robotics-rl-lf/vlm_datasets/DeepScaleR-Preview-Dataset/off_sample_off_rollout-deepseek7b-freq_5_5-128x2_tracking_results' \
