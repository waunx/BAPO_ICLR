...
python3 -m recipe.bapo.main_bapo \
    ...
    algorithm.max_total_uids=128 \
    algorithm.max_reeval_ids=32 \
    algorithm.rollout_is_threshold=3 \
    ...
    trainer.experiment_name='off-bapo-freq_2_2-qwen3_8b-val8k_aime-test' \
