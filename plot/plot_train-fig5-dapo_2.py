    ...
    metrics_config = [
        {
            ...
            'title': 'Vision Geometry Task - Train Rewards',
            'ylabel': 'Train Rewards',
            'filename': '1_train_rewards.png'
        },
        {
            'metric_name': 'actor/entropy_loss',
            'title': 'Vision Geometry Task - Actor Entropy',
            'ylabel': 'Actor Entropy',
            'filename': '1_actor_entropy.png'
        },
        {
            'metric_name': 'response_length/mean',
            'title': 'Vision Geometry Task - Response Length',
            'ylabel': 'Response Length',
            'filename': '1_response_length.png'
        }
    ]
